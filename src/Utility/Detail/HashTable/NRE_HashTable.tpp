         ...
         namespace Utility {
             namespace Detail {
                 ...
                 inline BucketEntry<ValueType, StoreHash>::BucketEntry()
                         : BucketEntryHash<StoreHash>(), distanceToNext(EMPTY_BUCKET_DISTANCE), last(false) {
                 }
    
                 template <class ValueType, bool StoreHash>
                 inline
                 BucketEntry<ValueType, StoreHash>::BucketEntry(BucketEntry const& bucket) : BucketEntryHash<StoreHash>(
                         bucket), distanceToNext(EMPTY_BUCKET_DISTANCE), last(bucket.last) {
                     if (!bucket.isEmpty()) {
                 ...
                 template <class ValueType, bool StoreHash>
                 inline
                 BucketEntry<ValueType, StoreHash>::BucketEntry(BucketEntry&& bucket) : BucketEntryHash<StoreHash>(
                         bucket), distanceToNext(EMPTY_BUCKET_DISTANCE), last(bucket.last) {
                     if (!bucket.isEmpty()) {
                 ...
                 template <class ValueType, bool StoreHash>
                 inline void BucketEntry<ValueType, StoreHash>::setData(DistanceType distance, TruncatedHash h,
                                                                        ValueType&& newData) {
                 ...
                 template <class ValueType, bool StoreHash>
                 inline void BucketEntry<ValueType, StoreHash>::swapWithData(DistanceType& distance, TruncatedHash& h,
                                                                             ValueType& newData) {
                     using std::swap;
                 ...
                 template <class ValueType, bool StoreHash>
                 inline BucketEntry <ValueType, StoreHash>&
                 BucketEntry<ValueType, StoreHash>::operator =(BucketEntry const& bucket) {
                     if (this != &bucket) {
                         clear();
                 ...
                 template <class ValueType, bool StoreHash>
                 inline BucketEntry <ValueType, StoreHash>&
                 BucketEntry<ValueType, StoreHash>::operator =(BucketEntry&& bucket) {
                     if (this != &bucket) {
                         clear();
                 ...
                 template <class K>
                 inline HashTable<Key, T, StoreHash, Hash, KeyEqual>::ForwardIterator<K>::ForwardIterator(
                         BucketEntry <ValueType, STORE_HASH>* bucket) : current(bucket) {
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 template <class K>
                 inline HashTable<Key, T, StoreHash, Hash, KeyEqual>::ForwardIterator<K>::ForwardIterator(
                         const BucketEntry <ValueType, STORE_HASH>* bucket) : current(
                         const_cast <BucketEntry <ValueType, STORE_HASH>*> (bucket)) {
                 }
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 template <class K>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::template ForwardIterator<K>&
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::ForwardIterator<K>::operator ++() {
                     while (true) {
                 ...
                 template <class K>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::template ForwardIterator<K>
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::ForwardIterator<K>::operator ++(int) {
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 template <class K>
                 inline bool HashTable<Key, T, StoreHash, Hash, KeyEqual>::ForwardIterator<K>::operator ==(
                         ForwardIterator const& it) const {
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 template <class K>
                 inline HashTable<Key, T, StoreHash, Hash, KeyEqual>::LocalForwardIterator<K>::LocalForwardIterator(
                         BucketEntry <ValueType, STORE_HASH>* bucket) : current(bucket) {
                 }
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 template <class K>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::template LocalForwardIterator<K>&
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::LocalForwardIterator<K>::operator ++() {
                     current = nullptr;
                     return *this;
                 }
                 ...
                 template <class K>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::template LocalForwardIterator<K>
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::LocalForwardIterator<K>::operator ++(int) {
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 template <class K>
                 inline bool HashTable<Key, T, StoreHash, Hash, KeyEqual>::LocalForwardIterator<K>::operator ==(
                         LocalForwardIterator const& it) const {
                     return current == it.current;
                 }
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::HashTable(std::size_t bucketCount, Hash const& hasher,
                                                                         KeyEqual const& equal) : Hash(hasher),
                                                                                                  KeyEqual(equal),
                                                                                                  nbElements(0),
                                                                                                  maxLoadFactor(
                 ...
                 inline HashTable<Key, T, StoreHash, Hash, KeyEqual>::HashTable(InputIterator begin, InputIterator end,
                                                                                std::size_t bucketCount,
                                                                                Hash const& hasher,
                                                                                KeyEqual const& equal) : HashTable(
                         bucketCount, hasher, equal) {
                     insert(begin, end);
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline HashTable<Key, T, StoreHash, Hash, KeyEqual>::HashTable(std::initializer_list<ValueType> list,
                                                                                std::size_t bucketCount,
                                                                                Hash const& hasher,
                                                                                KeyEqual const& equal) : HashTable(
                         bucketCount, hasher, equal) {
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline HashTable<Key, T, StoreHash, Hash, KeyEqual>::HashTable(HashTable const& table) : Hash(table),
                                                                                                          KeyEqual(
                                                                                                                  table),
                                                                                                          data(table.data),
                                                                                                          nbElements(
                                                                                                          ...
                                                                                                          maxLoadFactor(
                                                                                                                  table.maxLoadFactor),
                                                                                                          growAtNextInsert(
                                                                                                                  table.growAtNextInsert) {
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline HashTable<Key, T, StoreHash, Hash, KeyEqual>::HashTable(HashTable&& table) : Hash(
                         std::move(static_cast <Hash&> (table))), KeyEqual(std::move(static_cast <KeyEqual&> (table))),
                                                                                                     data(std::move(
                                                                                                             table.data)),
                                                                                                     nbElements(
                                                                                                             table.nbElements),
                 ...
                 inline void HashTable<Key, T, StoreHash, Hash, KeyEqual>::setMaxLoadFactor(float factor) {
                     if (factor < 0.0f || factor > 1.0f) {
                         throw std::out_of_range(
                                 "NRE::Utility::HashTable max load factor must be between 0.0 and 1.0.");
                     }
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::begin() {
                     std::size_t index = 0;
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::begin() const {
                     std::size_t index = 0;
                     while (index < getBucketCount() && data[index].isEmpty()) {
                         ++index;
                     }
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::cbegin() const {
                     return begin();
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::end() {
                     return Iterator(data.getData() + data.getSize());
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::end() const {
                     return ConstIterator(data.getData() + data.getSize());
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::cend() const {
                     return end();
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::LocalIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::begin(std::size_t index) {
                     return LocalIterator(&data[index]);
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstLocalIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::begin(std::size_t index) const {
                     return ConstLocalIterator(&data[index]);
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstLocalIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::cbegin(std::size_t index) const {
                     return begin();
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::LocalIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::end(std::size_t index) {
                     return LocalIterator(nullptr);
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstLocalIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::end(std::size_t index) const {
                     return ConstLocalIterator(nullptr);
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstLocalIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::cend(std::size_t index) const {
                     return end();
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline Pair<typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator, bool>
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::insert(ValueType const& value) {
                 ...
                 template <class P>
                 inline Pair<typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator, bool>
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::insert(P&& value) {
                 ...
                 template <class InputIterator>
                 inline void
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::insert(InputIterator begin, InputIterator end) {
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline void
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::insert(std::initializer_list<ValueType> list) {
                     insert(list.begin(), list.end());
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::insertHint(ConstIterator, ValueType const& value) {
                 ...
                 template <class P>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::insertHint(ConstIterator, P&& value) {
                 ...
                 template <class ... Args>
                 inline Pair<typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator, bool>
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::emplace(Args&& ... args) {
                 ...
                 template <class ... Args>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::emplaceHint(ConstIterator, Args&& ... args) {
                 ...
                 inline void HashTable<Key, T, StoreHash, Hash, KeyEqual>::rehash(std::size_t count) {
                     count = std::max(count, static_cast <std::size_t> (std::ceil(
                             static_cast <float> (getSize()) / getMaxLoadFactor())));
                     ...
                     for (auto& bucket : data) {
                         if (!bucket.isEmpty()) {
                             std::size_t hashValue = (useStoredHash)
                                                     ? (static_cast <std::size_t> (bucket.getTruncatedHash()))
                                                     : (newTable.hashKey(bucket.getData().first));
                             newTable.insertOnRehash(newTable.bucketFromHash(hashValue), 0, TruncatedHash(hashValue),
                                                     std::move(bucket.getData()));
                         }
                     }
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline Pair<typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator, typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator>
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::equalRange(Key const& k) {
                     Iterator it = find(k);
                     return Pair<Iterator, Iterator>(it, (it == end()) ? (it) : (std::next(it)));
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline Pair<typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstIterator, typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstIterator>
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::equalRange(Key const& k) const {
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::find(Key const& k) {
                     return Iterator(const_cast <const HashTable&>(*this).find(k).current);
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::ConstIterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::find(Key const& k) const {
                     ...
                     while (distanceToNext <= data[index].getDistanceToNext()) {
                         if ((!USE_STORED_HASH_ON_LOOKUP || data[index].bucketHashEquals(hashValue)) &&
                             compareKey(data[index].getData().first, k)) {
                             return ConstIterator(data.getData() + index);
                         }
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::erase(Iterator pos) {
                     return erase(ConstIterator(pos.current));
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::erase(ConstIterator pos) {
                     pos.current->clear();
                     nbElements--;
                     ...
                     while (data[index].getDistanceToNext() > 0) {
                         ...
                         data[previousIndex].setData(newDistance, data[index].getTruncatedHash(),
                                                     std::move(data[index].getData()));
                         data[index].clear();
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline typename HashTable<Key, T, StoreHash, Hash, KeyEqual>::Iterator
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::erase(ConstIterator begin, ConstIterator end) {
                     if (begin == end) {
                     ...
                     std::size_t returnIndex = moveCloserIndex - std::min(moveCloserIndex - closerIndex,
                                                                          static_cast <std::size_t> (data[moveCloserIndex].getDistanceToNext()));
        
                     while (moveCloserIndex < getBucketCount() && data[moveCloserIndex].getDistanceToNext() > 0) {
                         closerIndex = moveCloserIndex - std::min(moveCloserIndex - closerIndex,
                                                                  static_cast <std::size_t> (data[moveCloserIndex].getDistanceToNext()));
                         DistanceType newDistance = static_cast <DistanceType> (
                                 data[moveCloserIndex].getDistanceToNext() - (moveCloserIndex - closerIndex));
            
                         data[closerIndex].setData(newDistance, data[moveCloserIndex].getTruncatedHash(),
                                                   std::move(data[moveCloserIndex].getData()));
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline HashTable <Key, T, StoreHash, Hash, KeyEqual>&
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::operator =(HashTable const& table) {
                     if (this != &table) {
                         Hash::operator =(table);
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline HashTable <Key, T, StoreHash, Hash, KeyEqual>&
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::operator =(HashTable&& table) {
                     if (this != &table) {
                         swap(table);
                         table.clear();
                     }
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline bool
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::compareKey(Key const& k1, Key const& k2) const {
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline std::size_t
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::bucketFromHash(std::size_t hashValue) const {
                     return hashValue & mask;
                 }
    
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline std::size_t
                 HashTable<Key, T, StoreHash, Hash, KeyEqual>::roundUpToPowerOfTwo(std::size_t count) const {
                     if (count == 0) {
                         return 1;
                     }
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline void HashTable<Key, T, StoreHash, Hash, KeyEqual>::insertValue(std::size_t index,
                                                                                       DistanceType distanceToNext,
                                                                                       TruncatedHash h,
                                                                                       ValueType& pair) {
                 ...
                 template <class Key, class T, bool StoreHash, class Hash, class KeyEqual>
                 inline void HashTable<Key, T, StoreHash, Hash, KeyEqual>::insertOnRehash(std::size_t index,
                                                                                          DistanceType distanceToNext,
                                                                                          TruncatedHash h,
                                                                                          ValueType&& pair) {
                     bool done = false;
