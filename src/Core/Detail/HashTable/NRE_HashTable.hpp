     ...
     * @brief Declaration of Core's API's Object : HashTable
     * @author Louis ABEL
     * @date 25/06/2019
            ...
            namespace Detail {
                ...
                class HashTable : public Stringable<HashTable<Key, T, Allocator, StoreHash, Hash, KeyEqual>>, private Hash, private KeyEqual {
                    ...
                    public :    // Traits
                        ...
                        using ConstIterator         = HashTableInner::ForwardIterator<ValueType, Core::ForwardIterator, BucketEntry<ValueType, STORE_HASH>>;
                        ...
                        using ConstLocalIterator    = HashTableInner::LocalForwardIterator<ValueType, Core::ForwardIterator, BucketEntry<ValueType, STORE_HASH>>;
                        /** STL compatibility */
                        using value_type            = ValueType;
                        /** STL compatibility */
