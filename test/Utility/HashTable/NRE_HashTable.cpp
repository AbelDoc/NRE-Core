    ...
    TEST(HashTable, Ctr) {
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table(0, std::hash<std::string>(), std::equal_to<std::string>());
    ...
    TEST(HashTable, CtrInput) {
        ...
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table(input.begin(), input.end(), 0, std::hash<std::string>(), std::equal_to<std::string>());
    ...
    TEST(HashTable, CtrList) {
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table({{"A", 1}, {"B", 2}, {"C", 3}}, 0, std::hash<std::string>(), std::equal_to<std::string>());
        assertEquals(this, table.getSize(), static_cast <std::size_t> (3));
        String str(table.toString());
        assertTrue(str.contains("(A, 1)"));
        assertTrue(str.contains("(B, 2)"));
    ...
    TEST(HashTable, CtrCopy) {
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table({{"A", 1}, {"B", 2}, {"C", 3}}, 0, std::hash<std::string>(), std::equal_to<std::string>());
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> copy(table);
    ...
    TEST(HashTable, CtrMove) {
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table({{"A", 1}, {"B", 2}, {"C", 3}}, 0, std::hash<std::string>(), std::equal_to<std::string>());
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> copy(std::move(table));
        assertEquals(this, copy.getSize(), static_cast <std::size_t> (3));
        String str(copy.toString());
        assertTrue(str.contains("(A, 1)"));
        assertTrue(str.contains("(B, 2)"));
    ...
    TEST(HashTable, BucketCount) {
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table(10, std::hash<std::string>(), std::equal_to<std::string>());
        assertGreaterOrEquals(this, table.getBucketCount(), static_cast <std::size_t> (10));
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table2(0, std::hash<std::string>(), std::equal_to<std::string>());
    ...
    TEST(HashTable, LoadFactor) {
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table(6, std::hash<std::string>(), std::equal_to<std::string>());
    ...
    TEST(HashTable, BeginBucket) {
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table({{"A", 1}}, 0, std::hash<std::string>(), std::equal_to<std::string>());
    ...
    TEST(HashTable, Swap) {
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table({{"A", 1}, {"B", 2}, {"C", 3}}, 0, std::hash<std::string>(), std::equal_to<std::string>());
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> swap(0, std::hash<std::string>(), std::equal_to<std::string>());
        assertEquals(this, table.getSize(), static_cast <std::size_t> (3));
    ...
    TEST(HashTable, Assign) {
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> table({{"A", 1}, {"B", 2}, {"C", 3}}, 0, std::hash<std::string>(), std::equal_to<std::string>());
        HashTable<std::string, int, false, std::hash<std::string>, std::equal_to<std::string>> assign(0, std::hash<std::string>(), std::equal_to<std::string>());
        assign = table;
